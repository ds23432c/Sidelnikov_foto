    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('creator', 'Создатель'), ('client', 'Клиент'), ('admin', 'Администратор')], default='client', max_length=20, verbose_name='Роль')),
                ('creator_type', models.CharField(blank=True, choices=[('photographer', 'Фотограф'), ('designer', 'Дизайнер'), ('illustrator', 'Иллюстратор'), ('videographer', 'Видеограф')], max_length=20, null=True, verbose_name='Тип создателя')),
